<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <body>
                ...
                <div class="app">
                    <div class="h3">
                        ...
                        <p>Copyright (c) 2003-05 RedHill Consulting Pty. Ltd. All rights reserved.s</p>
    ...
    <xsl:template match="check" mode="summary">
        <table border="1" width="100%" cellspacing="2" cellpadding="3">
            ...
            <tr>
                <td>Total number of raw lines</td>
                <td>
                    <xsl:value-of select="sum(//check/summary/@totalRawLineCount)"/>
                </td>
            </tr>
            <tr class="a">
